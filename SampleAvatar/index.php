...
<head>
    ...
    */
	...
	if ( !isset( $_SESSION['userToken']) || !isset( $_SESSION['tokenExpireTime']) || time() >= $_SESSION['tokenExpireTime'] )
	{
		...
		$tokenGenerator = new TokenGenerator("sachin.teckchandani@ontariotechu.net","a2S9WqZy3t5X7DcAi","https://sandbox-authservice.priaid.ch/login");
...
<body>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="#">Check symptoms</a>
    </li>
